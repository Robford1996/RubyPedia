...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference("Name.count") do
      post names_url, params: { name: { age: @name.age, birthday: @name.birthday, work: @name.work } }, as: :json
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { age: @name.age, birthday: @name.birthday, work: @name.work } }, as: :json
    assert_response :success
  end
